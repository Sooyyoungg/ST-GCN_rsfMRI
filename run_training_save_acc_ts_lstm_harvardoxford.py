...
for window_size in [50, 75, 100]: # [16, 32, 64, 128, 256, 512, 1200]:
    ...
    for fold in range(1, 6):
        ...
        for epoch in range(60001):  # number of mini-batches
            ...
            if epoch % 1000 == 0:  # print every K mini-batches
                ...
                with open('output/mlp_baseline/harvardoxford/windowsize_' + str(W) + '_fold_' + str(fold) + '.txt', 'a') as f:
    ...
    with open('output/mlp_baseline/harvardoxford_testing_acc_lstm_abcd_final.txt', 'a') as f:
