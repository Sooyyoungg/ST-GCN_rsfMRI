...
train_data = np.load('data(HCP)/train_data_1.npy')
train_label = np.load('data(HCP)/train_label_1.npy')
test_data = np.load('data(HCP)/test_data_1.npy')
test_label = np.load('data(HCP)/test_label_1.npy')
...
for window_size in [50, 75, 100]:#[16, 32, 64, 128, 256, 512, 1200]:
    ...
    for fold in range(1, 6):
        ...
        train_data = np.load('data(HCP)/train_data_'+str(fold)+'.npy')
        train_label = np.load('data(HCP)/train_label_'+str(fold)+'.npy')
        test_data = np.load('data(HCP)/test_data_'+str(fold)+'.npy')
        test_label = np.load('data(HCP)/test_label_'+str(fold)+'.npy')
