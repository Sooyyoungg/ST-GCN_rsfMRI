...
train_data = np.load('data/harvardoxford_train_data_all_run_1.npy')
train_label = np.load('data/harvardoxford_train_label_all_run_1.npy')
...
for window_size in [25, 50, 64, 75, 100, 128, 256, 1200]: # [128]:
    ...
    for fold in range(1, 6):
        ...
        for epoch in range(60001):  # number of mini-batches
            ...
            if epoch % 1000 == 0:  # print every K mini-batches
                ...
                with open('output/all_run/testing_acc_st_gcn_folds_abcd/harvardoxford/windowsize_' + str(W) + '_fold_' + str(fold) + '.txt', 'a') as f:
        ...
        for edge_imp in best_edge_imp_curr_fold:
            filename = "output/all_run/edge_importance_abcd/harvardoxford/edge_imp_layer_" + str(layer_num) + "_WS_" + str(W) + "_fold_" + str(fold)
    ...
    with open('output/all_run/testing_acc_st_gcn_folds_abcd/harvardoxford_testing_acc_st_gcn_abcd_final.txt', 'a') as f:
